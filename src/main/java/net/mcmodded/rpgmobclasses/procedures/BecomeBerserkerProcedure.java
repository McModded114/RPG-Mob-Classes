...
public class BecomeBerserkerProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		((LivingEntity) entity).getAttribute(RpgMobClassesModAttributes.STRENGTH.get()).setBaseValue(10);
		((LivingEntity) entity).getAttribute(RpgMobClassesModAttributes.RAGE.get()).setBaseValue(1);
		...
		((LivingEntity) entity).getAttribute(RpgMobClassesModAttributes.SPEED.get()).setBaseValue(10);
